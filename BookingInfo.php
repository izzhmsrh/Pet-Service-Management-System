...
<script type="text/javascript" src="loginCustomer.js"></script>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;500;600&display=swap" rel="stylesheet">
        <title>Search Booking | FURRYCAT</title>
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link active dropdown-toggle" data-toggle="dropdown">Account</a>
...
Search <input type="text" name="search" placeholder="Enter Customer ID"><br>
